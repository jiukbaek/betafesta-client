  ...
  return (
    <div className={styles.container}>
      <div className={styles.display}>
        <div className={styles.titleDesktop}>『2021 BETA 페스티벌』 아이디어톤</div>
        <div className={styles.content}>
          ...
          <div className={styles.info}>
            <div className={styles.titleMobile}>『2021 BETA 페스티벌』 아이디어톤</div>
            <div className={styles.infoContent}>
              <div>일 시</div>
              <div>2021. 11. 18. (목) ~ 2021. 11. 19. (금)</div>
              <div>접수 기간</div>
              <div>2021. 10. 29. (금) ~ 2021. 11. 16. (화)</div>
              <div>주최 주관</div>
              <div>안동시 / 안동대학교</div>
              <div>참가 구분</div>
            ...
            <div className={styles.buttons}>
              ...
              <div onClick={() => openLink("https://forms.gle/tZB2wMkPh8UFm7jY7")}>참가신청</div>
            </div>
          </div>
        </div>
      </div>
