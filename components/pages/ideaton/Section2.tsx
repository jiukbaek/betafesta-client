...
const FirstText: React.FC = ({ children }) => (
  <div className={styles.firstText}>· {children}</div>
);
  ...
  <div className={styles.container}>
    <div className={styles.display}>
      <div>
        <Title>목적</Title>
        <SubTitle>
          유망한 창업 아이템을 보유한 창업자 대상 경진대회를 통해 창업 능력을
          키우고 우수 아이템 시상을 통해 창업 분위기 확산
        </SubTitle>
      </div>
      <div>
        <Title>운영주체</Title>
      ...
      <div>
        ...
        <Content>
          창업자는 ｢중소기업창업 지원법｣ 시행령 제2조에 따른 창업의 범위와
          제3조에 사업의 개시일을 적용
        </Content>
        <Content>
          창업일은 개인사업자의 경우 사업개시일(사업자등록증상의 개업일),
          법인기업의 경우 법인등기부등본상 회사성립연월일을 기준
        </Content>
        <Content>
          다수의 사업자(개인, 법인)를 소지한 경우, 최초 등록한 사업자의 기준일로
          산정
        </Content>
      ...
      <div>
        <Title>참가 제외대상</Title>
        <SubTitle>
          타인의 특허, 실용신안 등 지식재산권을 침해하거나 침해할 우려가 있는
          아이템
        </SubTitle>
        <SubTitle>
          「중소기업창업 지원법」 시행령 제4조에 따라 창업에서 제외되는 업종과
        ...
        <Note>
          예비창업자의 경우 팀원의 수상내역을 포함, 기창업자는 대표자 수상내역만
          해당
        </Note>
        <Note>
          향후 참가자격 부적격 확인 시 참가자격 박탈 및 상금이 환수 될 수
          있습니다.
        </Note>
      </div>
      <div>
        ...
        <Content>
          접수 마감일에는 다수의 신청자 접속으로 홈페이지 접속이 원활하지 않거나
          오류가 발생할 수 있으니 미리 신청(마감 2~3일 전)하여 주시기 바랍니다.
        </Content>
        <Note>사업계획서 제출완료 이후에는 수정 불가</Note>
        <SubTitle>
          제출서류: 참가신청서(사업계획서)는 신청 시 제출, 요건검토를 위한
          증빙서류(대표자 신분증 사본 및 사실증명, 사업자등록증 사본 또는
          사업자등록증명원) 제출
        </SubTitle>
        <Content>신청 시 제출서류 : 참가신청서</Content>
        <Note>
          자격검토를 위한 모든 증빙서류는 공고일(21.10.27.)이후 발급된 것으로
          제출
        </Note>
        <Note>참가 신청서, 사업계획서에 기재된 내용에 대한 증빙서류 제출</Note>
        <Note>예비창업자(팀)은 팀원의 신분증사본, 사실증명 제출</Note>
        <Note>
          증빙서류 검토 시 제출내용에 대해 허위사실이 발견될 경우, 선정 대상에서
          제외
        </Note>
      </div>
      <div>
        ...
        <SubTitle>
          평가방법: 사업계획서·발표자료를 바탕으로 참가자(팀)의 문제인식,
          해결방안, 성장전략, 팀구성 등을 발표평가(발표 5분, 질의응답 5분)
        </SubTitle>
        <Note>
      ...
      <div>
        ...
        <Content>
          시상식에서 공개된 아이디어를 법적으로 보호받기 위해서는 신 청자가 공개
          이전에 직접 지식재산권을 획득하여야 하며, 아이디어가 출원 전에 공개된
        ...
        <SubTitle>
          동 경진대회 수상자로 선정된 이후 공고문 및 관련 규정 및 사업 계획서의
          내용을 허위 기재 또는 누락이 확인된 경우 선정 취소 및 상금 환수 등의
          불이익 조치를 받을 수 있음
        </SubTitle>
      </div>
      <div>
