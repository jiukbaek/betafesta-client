...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
  ...
  $ON_ATTACHPHOTO_OPEN_WINDOW: function () {
    ...
    this.htPopupOption.sProperties =
      "left=0,top=0,width=403,height=359,scrollbars=yes,location=no,status=0,resizable=no";
  ...
  makePopupURL: function () {
    var sPopupUrl = "/smarteditor/js/lib/photo_uploader/photo_uploader.html";
